    ...
    create table folderexperimentlink (
        id int8 not null,
        permissions int8 not null,
        version int4,
        child int8 not null,
    ...
    create table folderinstrumentlink (
        id int8 not null,
        permissions int8 not null,
        version int4,
        child int8 not null,
    ...
    alter table folder 
        add constraint FKfolder_parent_folder 
        foreign key (parent) 
        references folder  ;;
    ...
    alter table folder_config 
        add constraint FKfolder_config_map 
        foreign key (folder_id) 
        references folder  ;;
    ...
    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_parent_folder 
        foreign key (parent) 
        references folder  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table folderexperimentlink 
        add constraint FKfolderexperimentlink_child_experiment 
        foreign key (child) 
    ...
    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_parent_folder 
        foreign key (parent) 
        references folder  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table folderinstrumentlink 
        add constraint FKfolderinstrumentlink_child_instrument 
        foreign key (child) 
        references instrument  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_parent_folder 
        foreign key (parent) 
        references folder  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table folderplatelink 
        add constraint FKfolderplatelink_child_plate 
        foreign key (child) 
        references plate  ;;
