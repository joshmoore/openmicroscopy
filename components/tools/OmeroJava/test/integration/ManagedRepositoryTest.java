   ...
   extends AbstractServerTest
{
     ...
     *            how many of the source paths to actually upload. If the value
     *            is negative, all will be uploaded.
     * @return the resulting import location
     * @throws Exception
     *             unexpected
     */
    ImportState importFileset(List<String> srcPaths)
            throws Exception {
     ...
     *             unexpected
     */
    ImportState importFileset(List<String> srcPaths, int numberToUpload)
            throws Exception {
